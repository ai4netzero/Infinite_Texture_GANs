...
class Res_Discriminator(nn.Module):
    def __init__(self, img_ch=3,base_ch = 32,n_classes=0,leak =0,att = False
        ...
        if n_classes !=0 :
            ...
            elif self.cond_method =='concat_notFC':
        ...
        if n_classes > 0 and (self.cond_method =='concat' or self.cond_method =='concat_notFC'):
    ...
    def forward(self,x,y=None):
        ...
        if y is not None and self.cond_method =='concat':
            ...
            h = torch.cat((h,h_y),1)
        elif y is not None and self.cond_method =='concat_notFC':
